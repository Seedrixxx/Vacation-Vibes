...
export function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setShowChatBubble(false), 6000);
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      <AnimatePresence>
        {showChatBubble && (
          <motion.div
            ...
            className="rounded-2xl bg-charcoal px-4 py-2.5 text-sm font-medium text-white shadow-lg"
          >
      ...
      aria-label="Chat on WhatsApp"
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
      initial={{ scale: 0 }}
      animate={{ scale: 1 }}
